...
<figure class="text-center">
    Daly2MQTT <a id="software_version">%SOFTWARE_VERSION%</a> By <a href="https://github.com/softwarecrash/Daly2MQTT"
...
const char HTML_MAIN[] PROGMEM = R"rawliteral(%HEAD_TEMPLATE%
...
%FOOT_TEMPLATE%
<p hidden>Hidden Helper</p> )rawliteral";
const char HTML_REBOOT[] PROGMEM = R"rawliteral(%HEAD_TEMPLATE%
...
%FOOT_TEMPLATE%
<p hidden>Hidden Helper</p> )rawliteral";
const char HTML_SETTINGS[] PROGMEM = R"rawliteral(%HEAD_TEMPLATE%
...
<script>
    var Flash_Size = Number("%Flash_Size%");
...
%FOOT_TEMPLATE%
<p hidden>Hidden Helper</p> )rawliteral";
const char HTML_SETTINGS_EDIT[] PROGMEM = R"rawliteral(%HEAD_TEMPLATE%
